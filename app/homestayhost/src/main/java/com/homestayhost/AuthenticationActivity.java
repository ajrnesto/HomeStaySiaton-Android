    ...
    private void initializeCallbacks() {
        loginCallback = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                ...
                Toast.makeText(AuthenticationActivity.this, "Mobile Verification Failed: "+e, Toast.LENGTH_SHORT).show();
                                    ...
                                    public void onComplete(@androidx.annotation.NonNull Task<DocumentSnapshot> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            if (user.getLong("userType") == 2) {
                                                ...
                                                AUTH.signOut();
                                                Utils.simpleDialog(AuthenticationActivity.this, "Login Failed", "The account you are trying to log in is not a Host account. Please use the Homestay Siaton app for regular users.", "I Understand");
                                            }
                                        }
                                    }
                                });
                    ...
                    AUTH.signInWithCredential(credential)
                        .addOnCompleteListener(task -> {
                            if (task.isSuccessful()) {
                                ...
                                user.put("userType", 2);
                                user.put("uidReadable", Utils.generateShortUid());
                                                    ...
                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@androidx.annotation.NonNull Task<Void> task) {
                                                            if (task.isSuccessful()) {
                                                                ...
                                                                Toast.makeText(AuthenticationActivity.this, "Something went wrong. Please try again later.", Toast.LENGTH_SHORT).show();
                                                            }
                                                        }
                                                    });
                                        }
